...
{    
    ...
    internal static string PP_PORT = "BDPort";
    internal static string PP_USERNAME = "BDUsername";
    internal static string PP_PASSWORD = "BDPassword";
    internal static string PP_USER_ID = "BDUserId";
    internal static string PP_SavePassword = "BDSavePassword";
    internal static string PP_ID_LANGUAGE = "BDIdLanguage";
