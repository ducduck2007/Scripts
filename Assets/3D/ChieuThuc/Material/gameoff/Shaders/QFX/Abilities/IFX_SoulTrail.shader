...
Shader "QFX/IFX/Abilities/SoulTrail"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			fixed4 c = (_DissolveEdgeWidth > temp_output_134_0) ? _DissolveColor : ((UNITY_ACCESS_INSTANCED_PROP(Props, _ColorStart) * tex2DNode88.a) + ((lerpResult54 * tex2DNode45.r) * tex2DNode93.r * _FinalPower));
			o.Emission = c.rgb;
