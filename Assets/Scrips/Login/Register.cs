...
public class Register : ScaleScreen
{
    ...
    protected override void Start()
    {
        ...
        ifUsername.onEndEdit.AddListener(arg0 => { OnNextLine(FieldName.PASSWORD); });
        ifPassword.onEndEdit.AddListener(arg0 => { OnNextLine(FieldName.REPASSWORD); });
    ...
    private void ClickRegister()
    {
        ...
        // string gmail = ifGmail.text.Trim();
        
        // if (username.Length < C.LENGTH_MIN_USERNAME || !AgentCSharp.CheckUsernameValidate(username))
        // {
        //     ShowMessageWithAction(
        //         IdLanguage.TaiKhoanPhaiTu + " " + C.LENGTH_MIN_USERNAME + " " + IdLanguage.KyTuVaKhongChuaDacBiet,
        //         () => ifUsername.ActivateInputField());
        //     return;
        // }
        ...
        // {
        //     ShowMessageWithAction(
        //         IdLanguage.MatKhauPhaiTu + " " + C.LENGTH_MIN_PASWORD + " " + IdLanguage.KyTuBaoGomChuVaSo,
        //         () => ifPassword.ActivateInputField());
        //     return;
        // }

        // if (B.Instance.onEmail == 1)
        // {
        //     if (!AgentCSharp.ValidEmail(gmail))
        //     {
        //         ShowMessageWithAction("Vui lòng nhập đúng định dạng email", () => ifGmail.ActivateInputField());
        //         return;
        //     }  
        // }
